...
const buildWhatsAppLink = () => {
  const msg = 'Hi NAHM, I want to know about placement opportunities after the course.';
...
export default function PlacementCTA() {
  ...
  return (
    <div className="w-full max-w-[1536px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 2xl:px-20 py-12 sm:py-16">
      <motion.section
      ...
      >
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 items-stretch">
          ...
          <div className="lg:col-span-7 p-6 sm:p-10 lg:p-14 xl:p-16">
            ...
            >
              Ready to Launch Your <span className="text-[#e5be58]">Hospitality Career?</span>
            </motion.h2>
            ...
            >
              Enroll now and gain access to NAHM's 100% placement support, career counselling desk, and direct pipeline to Nexstay Hotels & Resorts and 50+ partner properties.
            </motion.p>
            ...
            >
              ...
              >
                ...
                <span>Talk to Placement Cell</span>
          ...
          <div className="hidden lg:block lg:col-span-5 relative self-stretch overflow-hidden">
            <motion.img
              ...
              alt="NAHM graduate receiving an offer letter"
